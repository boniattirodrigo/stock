...
func CreateStocks(dbConnection *gorm.DB) {
  tickers := []string {
    ...
    "ELET6", "EMBR3", "ENBR3", "ENGI11", "EQTL3", "FLRY3", "GGBR4",
    "GNDI3", "GOAU4", "GOLL4", "HAPV3", "HGTX3", "HYPE3", "IGTA3",
    "IRBR3", "ITSA4", "ITUB4", "JBSS3", "KLBN11", "LAME4", "LREN3",
    "MGLU3", "MRFG3", "MRVE3", "MULT3", "NTCO3", "PCAR3", "PETR3",
    "PETR4", "QUAL3", "RADL3", "RAIL3", "RENT3", "SANB11", "SBSP3",
    "SULA11", "SUZB3", "TAEE11", "TIMP3", "TOTS3", "UGPA3", "USIM5",
